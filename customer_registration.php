	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="container-fluid">	
			...
			<ul class="nav navbar-nav">
				...
				<li><a href="maintain.php"><span class="glyphicon glyphicon-modal-window"></span>Maintenance</a></li>
			...
			<div class="col-md-8">
				<div class="panel panel-primary">
					...
					<form id="signup_form" onsubmit="return false">
						...
						<div class="row">
							<div class="col-md-12">
								<a href="successsingup.php"><input style="width:100%;" value="Sign Up" type="submit" name="signup_button"class="btn btn-success btn-lg"></a>
							</div>
						</div>
